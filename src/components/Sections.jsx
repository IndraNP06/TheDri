                ...
                >
                    ...
                    <div className="contact-flex" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '2rem', flexWrap: 'wrap', gap: '2rem' }}>
                        <div className="social-flex" style={{ display: 'flex', gap: '2rem', alignItems: 'center' }}>
                            ...
                            <motion.a whileHover={{ color: 'var(--primary-color)' }} href="https://www.instagram.com/yovin.here/?hl=id" target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.9rem', fontWeight: 600, textDecoration: 'none', color: '#fff', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Instagram</motion.a>
